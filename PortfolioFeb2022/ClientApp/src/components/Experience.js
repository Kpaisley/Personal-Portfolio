            ...
            <div id="experience-page">
                <div className="experience-box-section">
                    <div className="experience-box">
                        ...
                        <h4>Features</h4>
                        <div id="react-features" className="hidden">
                            ...
                            <a href="https://shopping-demo-react.azurewebsites.net/" target="_blank">View Demo!</a>
                        </div>
                    </div>
                    <div className="experience-box">
                        <h2>Angular</h2>
                        ...
                        <h3>Shopping Cart Demo</h3>
                        <h4>Features</h4>
                        <div id="angular-features" className="hidden">
                            <ul className="features-list">
                                <li>Fully responsive UI that works on all devices</li>
                            ...
                            <a href="https://shopping-demo-angular.azurewebsites.net/" target="_blank">View Demo!</a>    
                        </div>
                    </div>
                </div>
                <div className="experience-bottom">
                    <h2>Internships</h2>
                    <p>I was fortunate enough to recieve an internship with STEM Montessouri Academy of Canada.</p>
                    <br />
                    <p>During this time I was assigned to help build and design STEM Canada's new website for their operations in the United States.</p>
                    <br />
                    <br />
                    <p> <a href="https://stemamerica.tech/" target="_blank">View the Project!</a></p>
                </div>
            </div>
        );
    }
